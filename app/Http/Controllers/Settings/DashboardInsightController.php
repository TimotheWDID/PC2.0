...
class DashboardInsightController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'ticket_pending_hours_by_priority' => ['required', 'array'],
            'ticket_pending_hours_by_priority.high' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_pending_hours_by_priority.medium' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_pending_hours_by_priority.low' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_low_info_hours' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_low_info_hours_by_priority' => ['required', 'array'],
            'ticket_low_info_hours_by_priority.high' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_low_info_hours_by_priority.medium' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_low_info_hours_by_priority.low' => ['required', 'integer', 'min:1', 'max:720'],
            'ticket_stalled_days' => ['required', 'integer', 'min:1', 'max:365'],
            'ticket_stalled_days_by_priority' => ['required', 'array'],
            'ticket_stalled_days_by_priority.high' => ['required', 'integer', 'min:1', 'max:365'],
            'ticket_stalled_days_by_priority.medium' => ['required', 'integer', 'min:1', 'max:365'],
            'ticket_stalled_days_by_priority.low' => ['required', 'integer', 'min:1', 'max:365'],
